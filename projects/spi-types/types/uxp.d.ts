...
export namespace uxp {
    ...
    namespace storage {
        ...
        class FileSystemProvider {
             ...
             */
            getFolder(options: { initialDomain?: symbol }): Promise<Folder>;
            /**
...
declare global {
     ...
     */
    class GestureEvent extends BaseUIEvent {
        constructor(type: any, eventInit: any);
     ...
     */
    class PointerEvent extends BaseUIEvent {
        constructor(type: any, eventInit: any);
        readonly pointerId: any;
        readonly width: number;
        readonly height: number;
